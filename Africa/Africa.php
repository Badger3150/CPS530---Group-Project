...
{
    $usr_msg = "<a class='nav-link' id='link' href='https://www.cs.ryerson.ca/~r35yu/project/login.php'>Login</a>";
}
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="https://www.cs.ryerson.ca/~r35yu/project/home.php">Home<span class="sr-only">Screen read only.</span></a>
                </li>
                <!-- a link to the questionnaire page -->
                <li class="nav-item">
                    <a class="nav-link" href="https://www.cs.ryerson.ca/~r35yu/project/questionnaire.php">Questionnaire</a>
                </li>
                <!-- a link point to the map -->
                <li class="nav-item">
                    <a class="nav-link" href="https://www.cs.ryerson.ca/~r35yu/project/home.php#map">Map</a>
                </li>
